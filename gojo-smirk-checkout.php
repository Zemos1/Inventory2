<?php
session_start();
require 'dbcongojo-smirk.php';

?>

<?php include('messagegojo-smirk.php'); ?>
...
<div class="checkout" style="margin-top:100px; margin-left:50px;">
  ...
  <img src="img/jujutsu/jujutsu3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Gojo Smirk 25PHP</h5>
