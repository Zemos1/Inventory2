...
<html lang="en">
  <head>
    <title>Gojo Six Eyes Checkout</title>
  ...
  <body>
    ...
    <div class="checkout" style="margin-top:100px; margin-left:120px;">
    <div class="card" style="width: 18rem;">
  <img src="img/jujutsu/jujutsu2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Gojo Six Eyes 25PHP</h5>
  </div>
</div>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="codegojo-six-eyes.php" method="POST">
