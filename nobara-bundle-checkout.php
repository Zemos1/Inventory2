<?php
session_start();
require 'dbconnobara-bundle.php';

?>

<?php include('messagenobara-bundle.php'); ?>
...
<div class="checkout" style="margin-top:100px; margin-left:50px;">
  ...
  <img src="img/jujutsu/nobara bundle.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Nobara Bundle 79PHP</h5>
