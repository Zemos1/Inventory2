<?php
session_start();
require 'dbconmegumi-bundle.php';

?>

<?php include('messagemegumi-bundle.php'); ?>
...
<div class="checkout" style="margin-top:100px; margin-left:50px;">
  ...
  <img src="img/jujutsu/megumi bundle.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Megumi Bundle 79PHP</h5>
    <a href="index.php" class="btn btn-dark">Return to website</a>
  </div>
</div>
</div> 
