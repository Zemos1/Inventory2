<?php
session_start();
require 'dbconjjk-bundle.php';

?>

<?php include('messagejjk-bundle.php'); ?>
...
<div class="checkout" style="margin-top:100px; margin-left:50px;">
  ...
  <img src="img/jujutsu/jjk bundle.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">JJK Chibi Bundle 89PHP</h5>
