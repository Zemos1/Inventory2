<?php
session_start();
require 'dbcongojo-jolly.php';

?>

<?php include('messagegojo-jolly.php'); ?>
...
<div class="checkout" style="margin-top:100px; margin-left:50px;">
  ...
  <img src="img/jujutsu/jujutsu1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Gojo Jolly 25PHP</h5>
